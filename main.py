...
# PromptTemplate varibles definition
prompt = PromptTemplate(
    input_variables=["review"],
    template=template
)

# LLM and key loading functions 
...
with col2:
    st.write("Contact with [AI SharedServices](https://www.globant.com) to build your AI Projects") 
